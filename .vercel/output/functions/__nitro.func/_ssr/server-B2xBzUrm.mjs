...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-YmCSLZAh.mjs");
...
const manifest = {
  "02c5b2b7a6bafd8ae75f068a47e31f85f38d0598b728ca196e876ce7b830a76b": {
    functionName: "getReportCardFn_createServerFn_handler",
    importer: () => import("./reports-Dg8JfOgt.mjs")
  },
  "177d130c3ffe872091455b2626b6320243772083af3159ecd08782d86f7e0884": {
    functionName: "getPrintSettingsFn_createServerFn_handler",
    importer: () => import("./print-settings-DxrTrbUr.mjs")
  },
  "1b94285088d192c8f7b0bc0a637b6477d2d8c54fd78da463e7b12260d3016f3e": {
    functionName: "updateSubjectFn_createServerFn_handler",
    importer: () => import("./subjects-D1fErmC2.mjs")
  },
  "231742f70c36c72f4e68314d58b1ab123c34da290259ba948318fc96359efcb4": {
    functionName: "createRombelFn_createServerFn_handler",
    importer: () => import("./classes-DglcZkxc.mjs")
  },
  "2bdd38139eeca6e30b2a66faa03f46fb49a91c1d064e61a1382ffe970ee69fe4": {
    functionName: "setActiveAcademicYearFn_createServerFn_handler",
    importer: () => import("./academic-years-CKLpulHK.mjs")
  },
  "2df384382049059de678b08b145b958783927ddc6fd64689d235333acc72123e": {
    functionName: "getStudentFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "3246a07ba8483bbbc0a01f2053f0b91a448c60de66255790967befd1e57c29f7": {
    functionName: "assignRombelFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "3336b8080f8b2a02d6549b7bd359b0c60feb032ed5078f69068814331599336c": {
    functionName: "getRombelsFn_createServerFn_handler",
    importer: () => import("./classes-DglcZkxc.mjs")
  },
  "38b1e7145c4f4ccf24e7929555d3c40bba0594e51cb868ffeaaccfec57c00987": {
    functionName: "getSubjectsFn_createServerFn_handler",
    importer: () => import("./subjects-D1fErmC2.mjs")
  },
  "42e90d44ad3b466567a6fbb9d45eb93a6af4275b7edff56909d78b7eac4c0c04": {
    functionName: "savePrintSettingsFn_createServerFn_handler",
    importer: () => import("./print-settings-DxrTrbUr.mjs")
  },
  "435ce2062fe92c765d66f882e26ad481339857b57117cb54a6aba4e0f9662cba": {
    functionName: "getClassesFn_createServerFn_handler",
    importer: () => import("./classes-DglcZkxc.mjs")
  },
  "4871087c59dcb9d2cd00b3053af05dc2712008d66ae34d8134c13361dafe490e": {
    functionName: "updateStudentFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "49fe1373250a2b8fa2c6be1fc9c71885412852f45d528bc0c44227082e325608": {
    functionName: "createStudentFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "4bf6a541f0c481826768b5d6ff4dd2e98f9266b87935027c5f77eafab8ea7036": {
    functionName: "deleteRombelFn_createServerFn_handler",
    importer: () => import("./classes-DglcZkxc.mjs")
  },
  "50e99733fc00951ed94cfc360ff63fc6de9cc83ce40e103200b14a373d6d4b56": {
    functionName: "deleteUserFn_createServerFn_handler",
    importer: () => import("./auth-BqMS0F-D.mjs")
  },
  "56300f58f9fb7e938424ac5ceb1f1083769c8f307dc880a8502761f31f5a8e81": {
    functionName: "getStudentsFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "5933a61ab511e82b12da3ce9c5121484fe0d4559b228edcb87f8b1485bec8c46": {
    functionName: "deleteSubjectFn_createServerFn_handler",
    importer: () => import("./subjects-D1fErmC2.mjs")
  },
  "5cb2ac8aaf83688410fa5793e8365e63f21fb04021042643addabf4f33797733": {
    functionName: "deleteAcademicYearFn_createServerFn_handler",
    importer: () => import("./academic-years-CKLpulHK.mjs")
  },
  "6a38eae3e4319b22e1704426c89876d6663b69f71ec627ab4a0a18fd5f7e96e8": {
    functionName: "toggleUserFn_createServerFn_handler",
    importer: () => import("./auth-BqMS0F-D.mjs")
  },
  "712e2034d3e2a505dca10c4474263f8496d4dda6e757e4b950474755f2d9a38a": {
    functionName: "updateRombelFn_createServerFn_handler",
    importer: () => import("./classes-DglcZkxc.mjs")
  },
  "71c1880e4d827eff34bff83a011bd4ffebfd507bee103c4dc806921ec19ee28d": {
    functionName: "updateProfileFn_createServerFn_handler",
    importer: () => import("./auth-BqMS0F-D.mjs")
  },
  "7b62f31003d29093ec89391258d659611da670a134ffc141e57219f951677f57": {
    functionName: "getValueTrendFn_createServerFn_handler",
    importer: () => import("./dashboard-Bdc0jG5G.mjs")
  },
  "878748079e9e832d22022a4dbd5dc08fc9eaa3323bf78b869a875df6aca0b001": {
    functionName: "getDashboardStatsFn_createServerFn_handler",
    importer: () => import("./dashboard-Bdc0jG5G.mjs")
  },
  "887f56ebd23b4905a5d67ace11f3c4eefdef22825f66f227414be017ea69b6f6": {
    functionName: "changePasswordFn_createServerFn_handler",
    importer: () => import("./auth-BqMS0F-D.mjs")
  },
  "8bd0613363d21bbf16a879929eb9c00600a291aa82c4ca42ba2a8f36ef72e222": {
    functionName: "getUsersFn_createServerFn_handler",
    importer: () => import("./auth-BqMS0F-D.mjs")
  },
  "9611de7b963f3895b1109843b15c9b1fc7ad5ab82990d5af529378907ff0ac82": {
    functionName: "getAcademicYearsFn_createServerFn_handler",
    importer: () => import("./academic-years-CKLpulHK.mjs")
  },
  "9c2a64d59a1f02b6f05e92cc6e77564b5a774827dedcde79adcef70d1e16a5e6": {
    functionName: "createAcademicYearFn_createServerFn_handler",
    importer: () => import("./academic-years-CKLpulHK.mjs")
  },
  "aece1b4106b8589059d9d6b49a1d7589878e13766766209cce51f7aa5c911735": {
    functionName: "createSubjectFn_createServerFn_handler",
    importer: () => import("./subjects-D1fErmC2.mjs")
  },
  "c52d88890e9cdeee6d9ddc04253872daea613898ba109398dc8958d0e44cca17": {
    functionName: "getClassRankingFn_createServerFn_handler",
    importer: () => import("./dashboard-Bdc0jG5G.mjs")
  },
  "c83e26be213224fdaf501b8781170802760503714870bc72c43249cbfa3391e9": {
    functionName: "deleteStudentFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "d98d23431d158ea0334a5e801b55e51818193bfbe45ad5d308e9027d4b28434b": {
    functionName: "getTopStudentsFn_createServerFn_handler",
    importer: () => import("./dashboard-Bdc0jG5G.mjs")
  },
  ...
  "e8e06ff860d1930ea22710367f0df4d6bce3aac088893acaa56d9cfbc2fcfc71": {
    functionName: "getMeFn_createServerFn_handler",
    importer: () => import("./auth-BqMS0F-D.mjs")
  },
  "f1829c3ea7c1e27e07b5831819d43408fbbcf70d3e3d1737d7f0e37e36b72350": {
    functionName: "getReportStudentsFn_createServerFn_handler",
    importer: () => import("./reports-Dg8JfOgt.mjs")
  },
  "f7bfce5ccc4c949250cc58c49844701236f70ad5bb5613d073980d9486284db2": {
    functionName: "bulkDeleteStudentsFn_createServerFn_handler",
    importer: () => import("./students-Ddf4aoSb.mjs")
  },
  "fc3163788c15aff1c2e290d35756bc459551f8171d77d9ae86d9da7cef7519a1": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-l0I_kZ8p.mjs").then((n) => n.r),
    import("./start-C73MMgfi.mjs"),
