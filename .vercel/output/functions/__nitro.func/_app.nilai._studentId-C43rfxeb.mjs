...
import { S as Switch } from "./_ssr/switch-CQ4rbtn8.mjs";
...
import { R as Route$4 } from "./_ssr/router-Bn0zc_Cj.mjs";
...
function ScoreInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id, className: "h-8 w-16 text-center px-1 mx-auto", placeholder: "—", value, onChange: (e) => {
...
function NilaiStudentPage() {
  ...
  if (!yearId || !rombelId) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center", children: "Data tahun ajaran atau rombel tidak valid." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-none relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "Pengaturan Penyimpanan" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2 border rounded-md px-3 py-1.5 bg-muted/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { id: "auto-save", checked: autoSave, onCheckedChange: setAutoSave }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "auto-save", className: "text-xs flex items-center cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3.5 h-3.5 mr-1 text-muted-foreground" }),
          " Auto-Save (5s)"
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "akademik", children: "Nilai Akademik" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "pidato", children: "Pidato 3 Bahasa" }),
        classLevel >= 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "komputer", children: "Praktik Komputer" }),
        classLevel >= 5 && /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "diskusi", children: "Diskusi" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "kehadiran", children: "Kehadiran" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "akademik", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "Nilai Akademik" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Mata Pelajaran" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-center", children: "Tugas" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-center", children: "UTS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-center", children: "UAS" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: (akademikData?.subjects ?? []).map((subj) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "font-medium", children: [
                subj.name,
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground font-normal", children: [
                  "Bobot: T:",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreInput, { id: `${subj.id}-tugas`, value: akademikState[`${subj.id}_tugas`] ?? "", onChange: (v) => {
                markDirty();
                setAkademikState((p) => ({
                  ...p,
                  [`${subj.id}_tugas`]: v
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreInput, { id: `${subj.id}-uts`, value: akademikState[`${subj.id}_uts`] ?? "", onChange: (v) => {
                markDirty();
                setAkademikState((p) => ({
                  ...p,
                  [`${subj.id}_uts`]: v
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreInput, { id: `${subj.id}-uas`, value: akademikState[`${subj.id}_uas`] ?? "", onChange: (v) => {
                markDirty();
                setAkademikState((p) => ({
                  ...p,
                  [`${subj.id}_uas`]: v
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => saveAkademikMut.mutate(), disabled: saveAkademikMut.isPending, className: "bg-emerald-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-4 w-4 mr-2" }),
            " Simpan Nilai Akademik"
          ] }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "pidato", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        LANGUAGES.map((lang) => {
          const row = speechState[lang] ?? {};
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between py-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-4", children: SPEECH_ASPECTS.map((asp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: SPEECH_LABELS[asp] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreInput, { id: `speech-${lang}-${asp}`, value: row[asp] ?? "", onChange: (v) => {
                markDirty();
                setSpeechState((p) => ({
                  ...p,
                  [lang]: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => saveSpeechMut.mutate(), disabled: saveSpeechMut.isPending, className: "bg-emerald-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-4 w-4 mr-2" }),
          " Simpan Nilai Pidato"
        ] }) })
      ] }) }),
      classLevel >= 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "komputer", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "Nilai Praktik Komputer" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-4", children: COMPUTER_ASPECTS.map((asp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: COMPUTER_LABELS[asp] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreInput, { id: `comp-${asp}`, value: compState[asp] ?? "", onChange: (v) => {
              markDirty();
              setCompState((p) => ({
                ...p,
                [asp]: v
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => saveCompMut.mutate(), disabled: saveCompMut.isPending, className: "bg-emerald-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-4 w-4 mr-2" }),
            " Simpan Nilai Komputer"
          ] }) })
        ] })
      ] }) }),
      classLevel >= 5 && /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "diskusi", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "Nilai Diskusi" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-5 gap-4", children: DISCUSSION_ASPECTS.map((asp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: DISCUSSION_LABELS[asp] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreInput, { id: `disc-${asp}`, value: discState[asp] ?? "", onChange: (v) => {
              markDirty();
              setDiscState((p) => ({
                ...p,
                [asp]: v
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => saveDiscMut.mutate(), disabled: saveDiscMut.isPending, className: "bg-emerald-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-4 w-4 mr-2" }),
            " Simpan Nilai Diskusi"
          ] }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "kehadiran", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "Data Kehadiran" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-4 max-w-lg", children: ["schoolDays", "present", "permission", "absent"].map((key) => {
            const labels = {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: labels[key] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: `att-${key}`, className: "h-8 w-16 text-center mx-auto px-1", placeholder: "0", value: attState[key] ?? "", onChange: (e) => {
                const v = e.target.value;
                if (v === "" || /^\d+$/.test(v)) {
                  markDirty();
                  setAttState((p) => ({
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => saveAttMut.mutate(), disabled: saveAttMut.isPending, className: "bg-emerald-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-4 w-4 mr-2" }),
            " Simpan Kehadiran"
          ] }) })
        ] })
